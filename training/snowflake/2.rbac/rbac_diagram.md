...
graph TD
  ...
  subgraph DB_RAW_DEV["RAW_DEV"]
    SCHEMA_SQL_SERVER_DEV[SQL_SERVER]
  end

  subgraph DB_RAW_PROD["RAW_PROD"]
    SCHEMA_SQL_SERVER_PROD[SQL_SERVER]
  end
  ...
  class DB_RAW_DEV,DB_RAW_PROD,DB_TRANS_DEV,DB_TRANS_PROD,SCHEMA_SQL_SERVER_DEV,SCHEMA_SQL_SERVER_PROD database
```
